...
namespace Sound
{
    public class PlayerAttack : Sounds
    {
        ...
        Margot.Player player;

        private void Awake()
        {
            player = GetComponent<Margot.Player>();
        }
        ...
        public void OnAttack(InputAction.CallbackContext context)
        {
            ...
            {
                GameObject bullet = GameManager.Instance.poolManager.bulletPool.GetBulletFromPool(Margot.BulletPool.BulletType.p_bullet, firePoint);
                bullet.GetComponent<Margot.Bullet>().Shoot(-bullet.transform.right, bulletForce);
                PlaySound(0);
